#!/usr/bin/env bash
# Transcript-replay harness for runtime gates 19–27 from SPEC §11.B.
#
# Per SPEC §10.4: "executes each fixture, captures the tool-call trace,
# asserts against expected-* files, and exits non-zero on first mismatch.
# Snapshot updates require explicit --update-snapshots and a reviewer comment."
#
