...
| High     | A deterministic gate fails for a real-world repo; degraded mode breaks | Next release                             |
...
- SemVer — pre-1.0 minors may break public interfaces (CHANGELOG calls out every break).
- Releases are tagged on `main` after the release dogfood gate passes.
